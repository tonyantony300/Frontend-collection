<p align="center">
  <p align="center">
   <img width="128px" src="gitbutler-app/icons/128x128@2x.png" />
	...
	<h1 align="center"><b>osvauld</b></h1>
	<p align="center">
		Credential management for teams in the most secure way
    <br />
    <a href="https://osvauld.com"><strong>osvauld.com »</strong></a>
    <br />
    <br />
  </p>
</p>
...
[![BADGE][s6]][l6] [![DISCORD][s2]][l2] [![INSTA][s3]][l3] 
...
Osvauld is a collaborative solution designed to address the problem of securely sharing credentials within your team. 

No more sharing your API keys or sensitive account passwords over Slack or Google Sheets; with Osvauld, you are in control of your data.

In a nutshell, it's a password manager not for the individual, but for teams.

## How does it work?

Private key is generated on the browser when user signs up. It will never be transferred over network and will stay exclusively in client browser encrypted.

Public key is shared across every web-client. Whenever new credential is added to osvauld, it will be encrypted with each public key before sending off to the backend. Owner of the corresponding private key can access the decrypted credential.


## How do Osvauld differ from other solutions like Bitwarden?
